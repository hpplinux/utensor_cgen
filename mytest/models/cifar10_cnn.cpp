...
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_1_Variable_quantized_min_0), 
            "conv_1/Variable_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_1_Variable_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_2_Variable_quantized_min_0), 
            "conv_2/Variable_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_2_Variable_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_3_Variable_quantized_min_0), 
            "conv_3/Variable_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_3_Variable_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_4_Variable_quantized_min_0), 
            "conv_4/Variable_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_4_Variable_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_5_Variable_quantized_min_0), 
            "conv_5/Variable_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_conv_5_Variable_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_fully_connect_weight_quantized_min_0), 
            "fully_connect/weight_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_fully_connect_weight_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<float>({}, inline_fully_connect_1_weight_quantized_min_0), 
            "fully_connect_1/weight_quantized_min:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<float>({}, inline_fully_connect_1_weight_quantized_max_0), 
...
{    
    ctx.add(new BinaryTensor<int>({1}, inline_fully_connect_2_logits_eightbit_fully_connect_2_weight__port__0_reshape_dims_0), 
            "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape_dims:0", 
            1);
}
{
    ctx.add(new RamTensor<float>(), "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape:0", 2);
    ctx.push(new ReshapeOp(), 
             { "fully_connect_2/weight:0", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape_dims:0" },
             { "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_fully_connect_2_logits_eightbit_fully_connect_2_weight__port__0_reduction_dims_0), 
            "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reduction_dims:0", 
            2);
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/min:0", 1);
    ctx.push(new MinOp(), 
             { "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape:0", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reduction_dims:0" },
             { "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/min:0" });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/max:0", 1);
    ctx.push(new MaxOp(), 
             { "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reshape:0", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/reduction_dims:0" },
             { "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/max:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:2", 1);
    ctx.push(new QuantizeV2Op(),
             {  "fully_connect_2/weight:0",  "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/min:0", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/max:0" },
             {  "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:0",  "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:1", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:2" });
    ctx.eval();
}
{
    ...
    ctx.push(new QntMatMulOp<uint8_t, uint8_t, int>(), 
             { "fully_connect_1/activation/eightbit:0", "fully_connect_1/activation/eightbit:1", "fully_connect_1/activation/eightbit:2", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:0", "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:1",  "fully_connect_2/logits_eightbit/fully_connect_2/weight__port__0/quantize:2" },
...
{    
    ctx.add(new BinaryTensor<int>({}, inline_pred_dimension_0), 
            "pred/dimension:0", 
            1);
}
{
